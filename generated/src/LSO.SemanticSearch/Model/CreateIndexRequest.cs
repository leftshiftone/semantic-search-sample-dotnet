...
namespace LSO.SemanticSearch.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateIndexRequest")]
    public partial class CreateIndexRequest : IEquatable<CreateIndexRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateIndexRequest(string name = default(string), List<IndexFieldMapping> fields = default(List<IndexFieldMapping>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateIndexRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "fields" is required (not null)
            if (fields == null)
            {
                throw new ArgumentNullException("fields is a required property for CreateIndexRequest and cannot be null");
            }
            this.Fields = fields;
        }
        ...
        {
            return this.Equals(input as CreateIndexRequest);
        }

        /// <summary>
        /// Returns true if CreateIndexRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIndexRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIndexRequest input)
        {
            if (input == null)
            {
                return false;
